...
description: Originally a PyQt5 application, utilize selenium, but now a web page.
...
[Flask Api](youtube-download-app-flask)\
[Nextjs frontend](youtube-download-app-nextjs)\
[YouTube Download PyQt5, GitHub Link](https://github.com/ivancetus/youtube-download-pyqt5)
...
I do however built a simple member login system using the server set up WordPress provides, it was mostly php, some python and javascript. You can try it [here](http://cosmowhale.asuscomm.com/website/), display in Chinese though.
...
## Posts detailed on how to make pyqt5 apps coming soon ...