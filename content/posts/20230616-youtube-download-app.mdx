---
title: YouTube Download App
description: Build with Nextjs 13 (on Vercel) and Flask Api (on Linode VPS)
slug: youtube-download-app
date: 2023-06-16
type: Post
tags: ['nextjs','flask','vps']
---
## Might implement Authentication at some point
Not sure how much traffic this app will generate, I have shared it with some my colleauges.

## Demo Site
https://yt.ivancetus.com/

## api
not accessible thourgh GET
https://flask.ivancetus.com/
